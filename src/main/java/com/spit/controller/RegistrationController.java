...
public class RegistrationController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/users_db?useSSL=false","root","root");
            ...
            ps = con.prepareStatement("insert into users (userid, username, useremail, userpassword) values(?,?,?,?)");
            ps.setString(1, u.getUserId());
            ps.setString(2, u.getUserName());
            ps.setString(3, u.getUserEmail());
            ps.setString(4, u.getUserPassword());
